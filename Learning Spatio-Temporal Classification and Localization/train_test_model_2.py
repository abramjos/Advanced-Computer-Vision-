...
#            import ipdb;ipdb.set_trace()
        ...
        if float(loss.data) < best_loss:
            ...
            torch.save(c3d.state_dict(), '%s/set_2_res_34_sgd_%d_%f.pth'%(args.save_folder,epoch+1,float(loss.data)))
